...
| AT-106 | current | governance_audit | optional design-stage integration decision is documented | Decision document records options, staged path, decision fields, and non-goals | docs/OPTIONAL_DESIGN_STAGE_PACK_INTEGRATION_DECISION.md | PASS | Owner decision remains PENDING |
