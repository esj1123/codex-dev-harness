...
The next recommended task is a separately approved Phase 9C Hermes sidecar
implementation boundary planning pass. It should remain documentation-first
unless the owner explicitly approves exact runtime files, scripts, commands,
safety tests, and side-effect boundaries for a minimal no-op sidecar
implementation.
